...
#import "ZHNLeftSlideViewController.h"
...
@interface ZHNLeftSlideViewController ()<UIGestureRecognizerDelegate>
{
...
@implementation ZHNLeftSlideViewController
...
- (instancetype)initWithLeftView:(UIViewController *)leftVC andMainView:(UIViewController *)mainVC
{
    if(self = [super init]){
        ...
        [self.leftVC.view addSubview:self.leftTableview];
