...
#define vSpeedFloat   0.8    //滑动速度

#define kLeftAlpha 1  //左侧蒙版的最大值
#define kLeftCenterX 0 //左侧初始偏移量
#define kLeftScale 1 //左侧初始缩放比例

#define vDeckCanNotPanViewTag    101   // 不响应此侧滑的View的tag
...
@interface ZHNLeftSlideViewController : UIViewController
